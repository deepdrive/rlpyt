...
config = dict(
    ...
    algo=dict(
        ...
        replay_ratio=4, #64  # In the paper, more like 0.8.  -> bigger better
        replay_size=int(1e6),
        learning_rate=1e-4,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--pre_trained_model',
                        ...
                        default='/home/isaac/codes/dd-zero/rlpyt/data/local/2020_06-07_01-02.12/r2d1_dd0/run_0/params.pkl'
                        )
